...
electricity_summarizer_agent = LlmAgent(
    ...
    instruction=load_instructions_file("Agents/electricity_summarizer/instructions.txt"),

    # Load agent description from external text file
    # Provides a brief summary of this agent's electricity estimation role
    description=load_instructions_file("Agents/electricity_summarizer/description.txt"),
